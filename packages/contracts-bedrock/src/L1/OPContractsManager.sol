...
contract OPContractsManager is ISemver {
    ...
    /// @notice Maps a contract name to it's implementation data.
    ...
    constructor(
        ...
        for (uint256 i = 0; i < _inputContracts.setters.length; i++) {
            ...
            Implementation storage impl = implementations[setter.name];
    ...
    function getLatestImplementation(string memory _name) internal view returns (Implementation memory) {
        // TODO: @blmalone fix this, it's going to have type safety with a new future design.
        Implementation storage impl = implementations[_name];
